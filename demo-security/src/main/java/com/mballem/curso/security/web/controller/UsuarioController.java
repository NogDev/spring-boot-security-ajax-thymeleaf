...
public class UsuarioController {
	...
	public ModelAndView preCadastroDadosPessoais(@PathVariable("id") Long usuarioId,
		...
		if (us.getPerfis().contains(new Perfil(PerfilTipo.ADMIN.getCod())) &&
			...
			model.addObject("message", "Os dados do paciente são restritas a ele.");
	...
	public String redefinirSenha(String email, ModelMap model) throws MessagingException {
		...
		model.addAttribute("sucesso", "Em instantes você receberá um e-mail para "
				+ "prosseguir com a redefinção de sua senha");
